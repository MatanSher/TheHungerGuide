...
import com.foodRecipe.TheHungerGuide.UploadUpdateRecipe.Upload_main_recipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivityMain.this, category_recipe.class)
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("users").child(usernameUser).child("RecipeMain");
