...
public class Upload_Extras_recipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Upload_Extras_recipe.this, category_recipe.class)
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Upload_Extras_recipe.this, myProfilePage.class)
                        .putExtra("name", nameUser)
                        .putExtra("email", emailUser)
                        .putExtra("username", usernameUser)
                        .putExtra("password", passwordUser)
    ...
    public void uploadRecipe() {
        ...
        FirebaseDatabase.getInstance().getReference("users")
                .child(usernameUser).child("RecipeDrinks").child(myCurrentDateTime).setValue(foodData).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {

                        if (task.isSuccessful()) {

                            Toast.makeText(Upload_Extras_recipe.this, "המתכון הועלה", Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Upload_Extras_recipe.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}