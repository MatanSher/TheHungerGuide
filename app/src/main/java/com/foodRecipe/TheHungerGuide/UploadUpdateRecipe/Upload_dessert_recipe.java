...
public class Upload_dessert_recipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Upload_dessert_recipe.this, category_recipe.class)
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Upload_dessert_recipe.this, myProfilePage.class)
                        .putExtra("name", nameUser)
                        .putExtra("email", emailUser)
                        .putExtra("username", usernameUser)
                        .putExtra("password", passwordUser)
    ...
    public void uploadRecipe() {
        ...
        FirebaseDatabase.getInstance().getReference("users")
                .child(usernameUser).child("dessertRecipe").child(myCurrentDateTime).setValue(foodData).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Upload_dessert_recipe.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
